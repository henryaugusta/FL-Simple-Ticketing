        ...
        <div class="card-body">
            ...
            <form action="{{ url('karyawan/'.$karyawan->id.'/edit') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" required name="nama" value="{{ $karyawan->name }}"
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" required name="email" value="{{ $karyawan->email }}"
                ...
                <div class="form-group">
                    ...
                    <select required class="form-control" required name="role" id="">
                        <option>Pilih Role</option>
                        <option @if ($karyawan->role == '2') selected @endif value="2">Karyawan</option>
