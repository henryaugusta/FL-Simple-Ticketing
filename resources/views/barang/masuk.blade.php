...
@section('page-breadcrumb')
    <div class="row">
        <div class="col-7 align-self-center">
            <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Manage Barang Masuk</h4>
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        <li class="breadcrumb-item text-muted active" aria-current="page">Barang Masuk</li>
    ...
    <div class="card border-primary">
        ...
        <div class="card-body">
            <form action="{{ url('barang/masuk') }}" method="post">
                ...
                <div class="form-group">
                    <label for="">Pilih Supplier Barang :</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" placeholder="Jumlah Barang Yang Masuk" class="form-control" name="jumlah"
                    ...
                    <tbody>
                        ...
                        @forelse ($masuk as $item)
                            <tr>
                                ...
                                <td>{{ $item->det_supplier->nama_toko }}</td>
                                <td>{{ $item->jumlah }}</td>
                                <td>{{ $item->created_at }}</td>
                                <td>
                                    <div class="d-flex">
                                        <button id="{{ $item->id }}" type="button"
                                            class="btn btn-danger btn-delete mr-2">Hapus Barang</button>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('body').on("click", ".btn-delete", function() {
                var id = $(this).attr("id")
                $(".btn-destroy").attr("href", window.location.origin + "/barang/masuk/" + id + "/cancel")
